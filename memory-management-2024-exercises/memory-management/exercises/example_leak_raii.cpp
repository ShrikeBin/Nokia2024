...
void process_event(const std::unique_ptr<Event>& event, RESOURCE* temp_resource, RESOURCE* proc_resource) noexcept
{
    try 
    {
...
int main(int ac, char* av[])
{
    ...
    std::vector simulation = { 12, 24, 36, 48, 60, 72, 84, 96, 108, 120, 132, 144};
